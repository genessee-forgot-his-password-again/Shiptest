...
/datum/design/health_hud_night
	...
	id = "health_hud_night"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 600, /datum/material/glass = 300, /datum/material/uranium = 1000)
...
/datum/design/security_hud
	...
	id = "security_hud"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 500, /datum/material/glass = 25)
...
/datum/design/diskplantgene
	...
	id = "diskplantgene"
	build_type = PROTOLATHE
	materials = list(/datum/material/plastic=200, /datum/material/glass = 100)
...
/datum/design/donksoft_refill
	name = "Toy Gun Vendor Refill"
	desc = "A refill canister for Toy Gun Vendors."
	id = "donksoft_refill"
	build_type = PROTOLATHE
...
/datum/design/sechudhl
	...
	id = "sechudhl"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 1050, /datum/material/glass = 2000, /datum/material/plasma = 500)
...
/datum/design/sechudinteq
	...
	id = "sechudinteq"
	build_type = PROTOLATHE
	materials = list(/datum/material/iron = 500, /datum/material/glass = 2000, /datum/material/plasma = 500)
